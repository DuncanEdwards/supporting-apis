...
export const addAnimalsEndpoint = (app: Express) => {
  const ENDPOINT_BASE = "/farm-api";

  app.get(`${ENDPOINT_BASE}/animals`, async (req, res) => {
  ...
  app.get(`${ENDPOINT_BASE}/animal-types`, async (_, res) => {
  ...
  app.get(`${ENDPOINT_BASE}/animal-sort-options`, async (req, res) => {
